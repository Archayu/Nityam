...
module.exports = {
  name: ["embed"],
  description: "create a embed in a channel",
  category: "Utility",
  options: [
    {
      name: "channel",
        ...
        i.reply({
          embeds: [
            new EmbedBuilder()
              ...
              .setFooter({
                text: 'Type "cancel" to cancel this interaction.\nNote: For Discord API, you need to provide colors like client.color, "Red"... etc. The color name always starts with a capital letter.',
              })
              .setColor(client.color),
          ],
          ephemeral: true,
