const {
  ...
  module.exports = {
    name: ["messages", "reset-all"],
    description: "Reset All The messages In The Guild",
    category: "Messages",
    options: [],
    permissions: {
      channel: [],
    ...
    run: async (interaction, client) => {
      ...
      .setTitle("**⚠ Are You Sure You Want To Reset All Messages In The Guild**")
      ...
      collector.on('collect', async (interaction) => {
          ...
          if(id === "yes") {
              ...
              await message.edit({ content: "Reseted All Messages Of The Guild", embeds: [], components: []})
          } else {
